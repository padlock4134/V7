                  ...
                  {shelfItems.map((ing, idx) => (
                    <div key={idx} className="flex flex-col items-center mx-2">
                      ...
                      <div className="w-16 h-20 bg-weatheredWhite border-2 border-yellow-700 rounded-b-lg rounded-t-md shadow relative flex flex-col items-center justify-end">
                        ...
                        <span className="text-xs font-semibold mt-8 text-maineBlue break-words text-center px-1">{ing.name}</span>
                        <span className="absolute bottom-1 left-1/2 -translate-x-1/2 text-[10px] text-yellow-900 bg-sand px-1 rounded">{ing.category}</span>
                      </div>
                      <button
